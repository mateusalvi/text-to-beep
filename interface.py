...
class interface:
    ...
    layout = [
        [sg.Text(" ", size = (10, 1))], # Tabela com os elementos da interface (linhas e colunas)
        [
            sg.Text(" ", size = (14, 1)),
    ...
    # play() altera o botão de play e demais para DESABILITADO e stop para HABILITADO. Significando que o software esta reproduzindo a musica
    # e nao deve receber nenhum outro input alem de STOP
    def play(self):
